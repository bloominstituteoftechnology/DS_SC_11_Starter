...
class OpenAQ(API):
    ...
    def sensors_by_location_id(self, location_id, **kwargs):
        ...
        """
        return self._get(f'locations/{location_id}/sensors', **kwargs)

    def measurements_by_sensor_id(self, sensor_id, **kwargs):
        ...
        :return: (status_code, response_data)
        """
        return self._get(f'sensors/{sensor_id}/measurements', **kwargs)
